...
//     colors = ['rgba(131, 228, 48,' + opacity + ')',       // an array of rgb colors for the circles
//               'rgba(47, 104, 228,' + opacity + ')',
//               'rgba(255, 251, 25,' + opacity + ')',
//               'rgba(28, 22, 22,' + opacity + ')',
//               'rgba(84, 54, 149,' + opacity + ')'
//              ],
//     minSize = 50,                                        // the minimum size of the circles in px
//     maxSize = 50,                                       // the maximum size of the circles in px
//     numCircles = 17,                                   // the number of circles
